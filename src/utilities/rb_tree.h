...
template<typename T>
Node<T> *RedBlackTree<T>::searchTreeHelper(Node<T> *node, int key) {
...
template<typename T>
void RedBlackTree<T>::deleteFix(Node<T> *x) {
  Node<T> *s;
...
template<typename T>
void RedBlackTree<T>::deleteNodeHelper(Node<T> *node, int key) {
  Node<T> *z = TNULL;
  Node<T> *x, *y;
  while (node != TNULL) {
    if (node->data == key) {
...
// Inserting a node
template<typename T>
void RedBlackTree<T>::insert(int key) {
